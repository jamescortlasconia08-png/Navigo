      ...
      <main className="p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Choose the perfect plan for your travel adventures. Upgrade anytime
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 relative">
            ...
            <ul className="space-y-2 mb-6">
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Search
                destinations, flights & hotels
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Simple
                itineraries
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Limited
                travel guides
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Last 3 trips
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>1 calendar
              </li>
            </ul>
            <button
              className="w-full bg-gray-300 text-gray-600 py-2 rounded-lg"
              disabled
            >
              Current Plan
            </button>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
            ...
            <ul className="space-y-2 mb-6">
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>AI
                recommendations
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Booking &
                cloud storage
              </li>
              <li>
              ...
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Offline
                access
              </li>
              <li>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
            ...
            <ul className="space-y-2 mb-6">
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>All Traveler
                features
              </li>
              <li>
              ...
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Group travel
                (up to 10)
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Integrated
                travel insurance
              </li>
              <li>
                <i className="fas fa-check text-green-500 mr-2"></i>Priority
        ...
        <div className="mt-12 bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">
            Our travel experts are here to help you find the perfect plan for
            your adventures. All plans include secure cloud storage, mobile
            sync, and 30-day money-back guarantee.
          </p>
          ...
          <div className="flex justify-center space-x-4 mb-4">
            ...
            <button className="border border-gray-300 dark:border-gray-600 px-6 py-2 rounded-lg">
