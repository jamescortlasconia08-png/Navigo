        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
            <div className="max-w-xl w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6">
                <div className="text-center">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Create Business Account</h1>
                    <p className="text-gray-500 dark:text-gray-400">Join NaviGo to manage your business travel.</p>
                </div>
                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    <div className="md:col-span-2">
                        ...
                        <div className="relative mt-1">
                            ...
                            <input type="text" placeholder="Your Company, Inc." className="w-full pl-10 pr-3 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-lg" />
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="relative mt-1">
                            ...
                            <input type="email" placeholder="you@company.com" className="w-full pl-10 pr-3 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-lg" />
                        </div>
                    </div>
                    <div className="md:col-span-2">
                        ...
                        <div className="relative mt-1">
                            ...
                            <input type="tel" placeholder="+1 (555) 000-0000" className="w-full pl-10 pr-3 py-2.5 bg-gray-100 dark:bg-gray-700 rounded-lg" />
                        </div>
                    </div>
                    <div>
                ...
                <div className="text-center text-sm text-gray-500 dark:text-gray-400">
                    Already have an account? <Link to="/login/business" className="font-semibold text-cyan-600 hover:underline">Sign in here</Link>
                </div>
            </div>
        </div>
    );
